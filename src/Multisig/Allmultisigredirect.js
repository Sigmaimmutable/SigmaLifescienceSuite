...
const Allmultisigsredirect = ({x,y}) => {  
  useEffect(() => {
...
{/*              
     ...
     <h6 style={{ fontWeight: "600", color: '#00d395' }}>0x00</h6>
                                      ...
                                      <center><h5> <strong>{ethBalance ? parseFloat(ethBalance/1000000000000000000) : "0.00"}</strong></h5></center><br/>
                ...
                <input required placeholder="value" type="text" className="form-control form-control-reset" id="address" onChange={event => setamount( event.target.value)}/>                
               
              </Col>   
              <h6 style={{ fontWeight: "600", color: '#00d395' }}><Button onClick={()=>{Transfer(amount)}}>send</Button></h6>
              </Row>           
...
export default Allmultisigsredirect;
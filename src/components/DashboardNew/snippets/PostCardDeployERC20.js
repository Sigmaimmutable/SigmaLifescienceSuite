...
import { BinanceERCPost } from '../../../API/ApiFunctions';
...
const PostCard = () => {
 ...
 //deploy DepositERC       
      ...
      await BinanceERCPost(createdtoken.options.address);
        ...
        <><ToastContainer position='bottom-right' draggable = {false} transition={Zoom} autoClose={10000} closeOnClick = {false}/></>
            <Card className='card-dash border-0 d-block'>
                ...
                <div className="post-card-footer">
                    <div>
                    <ButtonLoad loading={loaderParticipate} className='w-100 btn-blue' onClick={Deploy}>Deploy ERC20</ButtonLoad>                                   
                    </div>

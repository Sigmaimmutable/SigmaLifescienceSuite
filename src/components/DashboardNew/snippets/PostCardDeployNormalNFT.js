...
import normalnftabi from '../contracts/NFT/NormalNFT/NormalNFTabi';
import {normalnftdata} from '../contracts/NFT/NormalNFT/Normalnftdata'
import deployBond from '../../../assets/images/deploy-bond.jpeg'
import { BinanceNormalNFTPost } from '../../../API/ApiFunctions';
...
const PostCard = () => {
 ...
 //deploy NormalNFT      
        const createdNFT = await normalnftabi.deploy({
      
            data:normalnftdata,
            arguments: ["NFT","SNFT","https://gateway.pinata.cloud/ipfs/QmRDjU19xnUMkzhWXEUto1dqwQ51UCpB1EULiKzSx2dCzW",localStorage.getItem("walletAddress"),'0xD264b074c4a772E56536005Ae629518ee1bCc83a']        
            })
            .send({
            from: accounts[0],
            gas: 4796559,
      ...
      await BinanceNormalNFTPost(createdNFT.options.address);
            ...
            <Card className='card-dash border-0 d-block'>
                ...
                <div className="post-card-title mb-2 w-100 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        {createdToken === "" ? <></> : <><center><h5>Created NFTContract: <strong>{createdToken}</strong></h5></center><br/></>}
                ...
                <div className="post-card-footer">
                    <div>
                    <ButtonLoad loading={loaderParticipate} className='w-100 btn-blue' onClick={Deploy}>Deploy NFT</ButtonLoad>                                   
                    </div>

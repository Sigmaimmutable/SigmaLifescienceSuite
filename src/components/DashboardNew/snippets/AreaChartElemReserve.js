...
const token = {
   'X-API-Key': 'pOD5BAUCxq7InVPjo0sO01B0Vq4d7pD1ask5Ix43'}
    ...
    const treasuryHistory = async () =>
    {
        let amountTreasury = [];
        let timeTreasury = [];
        let totaltx = await indexClient.lookupAccountTransactions(dashboardDetails.elemReserveAddress).do();
        // console.log(totaltx);
        ...
        { 
           ...
           else
           {
            ...
            {
                if(totaltx['transactions'][i]['asset-transfer-transaction']['receiver'] === dashboardDetails.elemReserveAddress)
                { 

...
const PostCardNew = () => {
    ...
    const[makeWhite, setLoaderMakeWhite] = useState(false);

    const handleShowMakeWhite = () => setLoaderMakeWhite(true);
    const handleHideMakeWhite = () => setLoaderMakeWhite(false);
            ...
            <Card className='card-dash border-0 d-block'>
                ...
                <div className="post-card-footer">
                    ...
                    <input
                      ...
                      name="toaddress"
                    /> */}<br/>
                    <ButtonLoad loading = {makeWhite} className='w-100' onClick={whiteList}>Make WhiteList</ButtonLoad>

...
console.log("first",(props.ptoChild/1000000),(props.patochild/1000000))
    // const series1 = [(props.ptoChild/1000000),(props.patochild/1000000)];
    const series1 = [(props.ptoChild/1000000),(props.patochild/1000000)]
    const options1 = {
        chart: {
            height: 350,

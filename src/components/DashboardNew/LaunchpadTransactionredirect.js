...
import abi from './contracts/Launchpad/abi';
import launchpadabi from './contracts/Launchpad/launchpadabi'
import {ercdata} from './contracts/Launchpad/data';
import {launchdata} from './contracts/Launchpad/launchpaddata'
import web3 from "../../web3";
const LaunchpadTransactionredirect = ({x,y}) => {  
  useEffect(() => {
  ...
  const getmultisig =async()=>{   
    ...
    const dbcallProfile=async()=>{            
      if(localStorage.getItem("walletAddress")  === null || localStorage.getItem("walletAddress")  === "" || localStorage.getItem("walletAddress")  === " " || localStorage.getItem("wallet") === undefined || localStorage.getItem("walletAddress") === ''){
          ...
          .ref(`ContractAutoDeploy/${localStorage.getItem('walletAddress')}`)
          ...
          firebase.database().ref("ContractAutoDeploy").child(localStorage.getItem('walletAddress')).on("value", (data) => {          
              if (data) {  
                  try{
                  ...
                  Object.keys(datavar).map((m)=>{
                    ...
                    r.push({
                      ...
                      DepositToken:datavar[m].DepositToken,
                      purchaseTokenAddress:datavar[m].purchaseTokenAddress,
                      Tokenname:datavar[m].Tokenname,
                      contractAddress:datavar[m].contractAddress,
...
const copyCheck = () =>
{
    navigator.clipboard.writeText(x.contractAddress);
    handleCopied() 
}
...
{/*              
                            ...
                            <svg class="white me-2" width="16" height="16" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M15.8333 15.8333H4.16667V4.16667H10V2.5H4.16667C3.24167 2.5 2.5 3.25 2.5 4.16667V15.8333C2.5 16.75 3.24167 17.5 4.16667 17.5H15.8333C16.75 17.5 17.5 16.75 17.5 15.8333V10H15.8333V15.8333ZM11.6667 2.5V4.16667H14.6583L6.46667 12.3583L7.64167 13.5333L15.8333 5.34167V8.33333H17.5V2.5H11.6667Z"></path></svg>
                                      ...
                                      <div className="table-group-th">
                                          <div className="d-flex justify-content-left">
                                              <div className="table-group-td">
                                              <a style={{cursor:"pointer"}} className='mb-3 text-white d-flex align-items-center btn-link' onClick={() => copyCheck()}>
                            {x.purchaseTokenAddress.substring(0, 7)}...{x.purchaseTokenAddress.substring(x.purchaseTokenAddress.length -4, (x.purchaseTokenAddress).length)} <svg class="white me-2" width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M16 1H4C2.9 1 2 1.9 2 3V17H4V3H16V1ZM19 5H8C6.9 5 6 5.9 6 7V21C6 22.1 6.9 23 8 23H19C20.1 23 21 22.1 21 21V7C21 5.9 20.1 5 19 5ZM19 21H8V7H19V21Z"></path></svg>
                            <a className='mb-3  text-white d-flex align-items-center btn-link' href={"https://testnet.bscscan.com/address/" + x.purchaseTokenAddress} target="_blank" rel="noreferer">
                            <svg class="white me-2" width="16" height="16" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M15.8333 15.8333H4.16667V4.16667H10V2.5H4.16667C3.24167 2.5 2.5 3.25 2.5 4.16667V15.8333C2.5 16.75 3.24167 17.5 4.16667 17.5H15.8333C16.75 17.5 17.5 16.75 17.5 15.8333V10H15.8333V15.8333ZM11.6667 2.5V4.16667H14.6583L6.46667 12.3583L7.64167 13.5333L15.8333 5.34167V8.33333H17.5V2.5H11.6667Z"></path></svg>
     ...
     <h6 style={{cursor:"pointer", fontWeight: "600", color: '#00d395' }} >{x.startdate}</h6>
   
   </>):(<>
   
     <h6 style={{ fontWeight: "600", color: '#00d395' }}>startdate</h6>
       ...
       <h6 style={{cursor:"pointer", fontWeight: "600", color: '#00d395' }} >{x.enddate}</h6>
     
     </>):(<>
     
       <h6 style={{ fontWeight: "600", color: '#00d395' }}>enddate</h6>
...
export default LaunchpadTransactionredirect;
...
import { Col, Container, Row, Button, Dropdown, Card } from 'react-bootstrap';
import Layout from './LayoutT';
import Icon9 from '../../assets/images/cbdc/polygon-purple.png'
// import {
//     Link
...
function FarmPage() {
    ...
    return (
        <Layout>
            <Container fluid="sm">
                <h5 className='mb-20'>Bridge tokens to and from the Polygon Network</h5>

                <Card className='card-dash d-block border-0 mb-4'>
                    <Row className='align-items-center mb-0'>
                        <Col md={5}>
                            <div className="card-dropdown d-flex justify-content-center align-items-center">
                                ...
                                <div className="card-text">
                                    <span>From</span>
                                    <Dropdown>
                                        <Dropdown.Toggle variant="reset" className='px-0' id="dropdown-basic">
                                            CBDC
                                        </Dropdown.Toggle>
                        ...
                        <Col md={5}>
                            <div className="card-dropdown justify-content-center d-flex align-items-center">
                                <div className="card-icon">
                                ...
                                <div className="card-text">
                                    <span>To</span>
                                    <Dropdown>
                                        <Dropdown.Toggle className='px-0' variant="reset" id="dropdown-basic">
                                            EINR
                                        </Dropdown.Toggle>
                    ...
                    <div className="card-token p-0">
                        <div className="d-flex flex-sm-row flex-column mb-10 align-items-center justify-content-sm-between justify-content-center text-nowrap">
                        ...
                        <div className="d-flex flex-sm-row flex-column align-items-center justify-content-sm-between justify-content-center text-nowrap">
                            <span className='py-2 mb-sm-0 mb-2'>Balance on Polygon</span>
                ...
                <Button variant='primary' className='btn-blue w-100 mb-10'>Connect wallet</Button>

                                ...
                                <div >
                                    <Row>
                                        <Col md={6}>
                                            ...
                                            {sessionStorage.getItem("Farmimage1")===null||sessionStorage.getItem("Farmimage1")===undefined||sessionStorage.getItem("Farmimage1")==="" ? (<>   <img src={Icon1} style={{width:'40px',height:'40px'}} /> </>):(<>   <img src={sessionStorage.getItem("Farmimage1")} style={{width:'50px',height:'50px'}} /></>)}
                                            {sessionStorage.getItem("Farmimage2")===null||sessionStorage.getItem("Farmimage2")===undefined||sessionStorage.getItem("Farmimage2")===""  ? (<>   </>):(<>   <img src={sessionStorage.getItem("Farmimage2")} style={{width:'50px',height:'50px'}} /></>)}                                          
                                            <span className='d-flex mb-10 align-items-center' ><h5>Stake</h5></span>{sessionStorage.getItem("Farmname")===""||sessionStorage.getItem("Farmname")===undefined||sessionStorage.getItem("Farmname")===null? (<span className='d-flex mb-10 align-items-center' >  </span>):(<span  className='d-flex mb-10 align-items-center' ><h5>{sessionStorage.getItem("Farmname")}</h5></span>)}
                                  ...
                                  <Button variant='grad' className='px-2 py-2 w-100' onClick={optin}>App Opt-in</Button>
                                        ...
                                        <Col md={6} className='mt-md-0 mt-4'>
                                            <div className="balance-card py-md-3 d-flex mb-4 align-items-center justify-content-between">
                                            ...
                                            <div className="balance-card py-md-3 d-flex mb-4 align-items-center justify-content-between">
                                                <div className='h6 ms-1 py-3 d-flex align-items-center'>{sessionStorage.getItem("Farmname")===""||sessionStorage.getItem("Farmname")===undefined||sessionStorage.getItem("Farmname")===null? (<span  >  </span>):(<span  >{sessionStorage.getItem("Farmname")}</span>)} &nbsp;Staked
                                                {/* <div className="ms-2">
                                                    <OverlayTrigger
                                                        placement="top"
                                                        overlay={
                                            ...
                                            <div className="balance-card py-md-3 d-flex mb-4 align-items-center justify-content-between">
                                                <div className='h6 ms-1 py-3 d-flex align-items-center'>ELEM Earned 
                                                <div className="ms-2">
                                                    <OverlayTrigger
                                                        placement="top"
                                                        overlay={

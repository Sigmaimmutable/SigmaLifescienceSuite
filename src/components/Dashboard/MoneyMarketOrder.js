                        ...
                        <Col md={4} lg={4} xl={3} className='mb-xl-0 d-none mb-2'>
                            <div className="card-border-grad card-shadow card-market card-left">
                                <div className="card-border-grad-inner" style={{backgroundImage: `url(${BG})`}}>
                                    ...
                                    <div className='h8 mb-20'>Have assets you want to earn additional interest on ? Lend them in isolated markets and earn interest from borrowers.</div>
                                </div>
                            </div>
                        </Col>
                                ...
                                <div className="money-market-card-order-body">
                                    ...
                                    >
                                        <Tab eventKey="deposite" title="Deposit ALGO">
                                            <div className="pt-2">
                                                <div className="h3 mb-2 pb-2">Deposit ALGO</div>
                                        ...
                                        <div className="pt-2">
                                                <div className="h3 mb-2 pb-2">Withdraw ALGO</div>

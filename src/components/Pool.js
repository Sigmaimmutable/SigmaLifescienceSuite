    ...
    return (
        <Layout>
            <div className="page-content">
                <Container fluid="sm" style={{opacity: '0'}}>
 ...
 <img src={tau} width="31" height="30" alt='icon' />
      ...
      (tk2 == "USDC")?(<><small>Price:1 {tk2.toUpperCase()} = {usdcPrice > 0 ? parseFloat(usdcPrice).toFixed(2) :  '0.0'} USD</small></>):(<></>) }
                                        ...
                                        { (!showOptInButton && !showMintButton )?(<>
                                            <Button className='btn w-100 mb-20 text-none btn-grad btn-xl'  onClick={()=>bootstrap(appID_global,AssetId1,AssetId2)}>CREATE</Button>
                                        </>):(showOptInButton && !showMintButton)?(<>
                                            <Button className='btn w-100 mb-20 text-none btn-grad btn-xl'  onClick={()=>optIn(appID_global)}>Asset Opt-In</Button>
                                        </>):(<>
                                            <Button className='btn w-100 mb-20 text-none btn-grad btn-xl'  onClick={()=>mint(appID_global,AssetId1,AssetId2,input1,input2)}>CREATE LIQUIDITY</Button>
                                        </>)
                                        }
                        ...
                        <>
                            ...
                            <Row className='justify-content-center'>
                                <Col md={9} lg={8}>
                                    ...
                                    <Button className='btn w-100 mb-20 text-none btn-grad btn-xl' onClick={()=>mint1call(appID_global,samount1,samount2,rstate.asetName1,rstate.asetName2)}>ADD LIQUIDITY</Button>

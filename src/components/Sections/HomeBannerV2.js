            ...
            <Container fluid="lg">
                <Row className='align-items-center justify-content-between'>
                    ...
                    <Col xl={5} lg={7}>
                        ...
                        <p>ELEM is the first decentralized Liquidity-Owned Algorithmic Currency on the blockchains soft-pegged and undergoes a scheduled rebase to withstand price balance.</p>
                        <div className="pt-0">

...
import Allkycredirect from "./Allkycredirect";
      ...
      {localStorage.getItem('walletAddress') === null || localStorage.getItem('walletAddress') === undefined || localStorage.getItem('walletAddress') === "" ? (
        ...
        <Row className="justify-content-center">
          ...
          <Container fluid>
                ...
                <h2 className="h3 text-uppercase mb-40">Reports</h2>
                   ...
                   <div className="table-group-head">
                        ...
                        <div className="table-group-th">s.no</div>
                               ...
                               <div className="table-group-th">Wallet Address </div>
                               <div className="table-group-th">Uploaded Image</div>
                        ...
                        <div className="table-group-tr">
                               ...
                               <div className="table-group-th">send BNB</div> */}
                               </div>
                           </div>
